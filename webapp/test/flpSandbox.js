		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "S4HANA UI Extenstion",
									"targetURL": "#sapbtpossapui5bp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpossapui5bp-display": {
								"semanticObject": "sapbtpossapui5bp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.ossapui5bp",
									"url": sap.ui.require.toUrl("sap/btp/ossapui5bp")
								}
							}
						}
					}
